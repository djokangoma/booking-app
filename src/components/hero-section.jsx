    ...
    <div className="imageBg relative flex items-end justify-center">
      ...
      <div className="heroSection flex content-center item-center justify-around w-11/12 h-28 bg-[#faf9f5] absolute -bottom-10  rounded-md ">
        <div className="relative">
          ...
          <input
            type="text"
            className="cardReservation mt-1 px-3 py-2 bg-white border shadow-sm border-black-300 placeholder-black- focus:outline-none focus:border-[#000] focus:ring-[#000] block w-full rounded-md sm:text-sm focus:ring-1 "
        ...
        <div>
          ...
          <div className="boxDate relative mt-1 px-3 py-2 bg-white border shadow-sm bordel-black-300 h-10 w-60 cursor-pointer z-20 ">
        ...
        <div>
          ...
          {openOptions && (
            <div className="boxOption absolute -bottom-17 bg-white w-60 ">
